...
#define aodvHelloEnabled false
#define defaultSeed 273

uint16_t prev_role[numOfNodes];
uint16_t prev_nNodes[numOfNodes];

uint32_t globalEesoaTxAcc;
uint32_t globalNonEesoaTxAcc;
...
int main (int argc, char *argv[])
{
  ...
  wifiMac.SetType ("ns3::EESOA","QosSupported", BooleanValue (false));
  //
  // *********************************** CHANGE MAC HERE ****************************************************** 
